function renderQuadMesh(OBJfile, meshColor,...
...
%     vertexNormal_3V = getVertexNormal(vertex_3V,face_3F,faceNormal_3F);  
    ...
    vertexCoordinatesPerFace_34F = ...
        reshape( vertex_3V( 1:3, face_3F(:) ), [3 4*size(face_3F,2)]);
...
% face
    glBindVertexArray(vaoID(1));   
        ...
        glBufferData(GL_ARRAY_BUFFER, ...
            size(vertexCoordinatesPerFace_34F,1)*...
            size(vertexCoordinatesPerFace_34F,2)*8, ...
            vertexCoordinatesPerFace_34F, GL_STATIC_DRAW); 
...
%% Draw array
    ...
    glLineWidth(1);
    glBindVertexArray(vaoID(1));
        glDrawArrays(GL_QUADS, 0, 4*size(face_3F,2));  	
    glBindVertexArray(0);
...
%     imshow(imageArray_HW3);
    ...
    filename = sprintf('mesh_%05d.png',count);
